...
package com.example.aluno.olay.slidinguppanel;
...
public class ViewDragHelper {
    ...
    public static ViewDragHelper create(ViewGroup forParent, Callback cb) {
        return new com.example.aluno.olay.slidinguppanel.ViewDragHelper(forParent.getContext(), forParent, null, cb);
    }
    ...
    public static ViewDragHelper create(ViewGroup forParent, Interpolator interpolator, Callback cb) {
        return new com.example.aluno.olay.slidinguppanel.ViewDragHelper(forParent.getContext(), forParent, interpolator, cb);
    }
    ...
    public static ViewDragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
        final com.example.aluno.olay.slidinguppanel.ViewDragHelper helper = create(forParent, cb);
    ...
    public static ViewDragHelper create(ViewGroup forParent, float sensitivity, Interpolator interpolator, Callback cb) {
        final com.example.aluno.olay.slidinguppanel.ViewDragHelper helper = create(forParent, interpolator, cb);
        helper.mTouchSlop = (int) (helper.mTouchSlop * (1 / sensitivity));
        return helper;
    }
